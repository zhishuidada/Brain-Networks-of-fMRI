...
%
%  - Modified by Ameera X Patel (10th Feb 2014)
%
function [nii, obQ] = load_nii(filename, img_idx, dim5_idx, dim6_idx,...
    dim7_idx, old_RGB, tolerance, preferredForm)
...
%   nii.ext = load_nii_ext(filename);
   ...
   [nii,obQ] = xform_nii(nii, tolerance, preferredForm);
   if obQ==1; nii=[]; return; end
