...
% of two different parameters���� and �á�that tune the resolution
% of the community structure (��) and the strength of interlayer
% coupling (��). As a standard and in absence of an a priori hypothesis,
